...
<div class="relative flex items-center gap-3">
  <div class="flex-1 relative">
    <Input
      bind:value
      placeholder="Hold spacebar to record, then press Enter to process..."
      readonly
      size="lg"
      class="pr-4 text-base {isRecording ? 'ring-2 ring-red-500' : ''}"
    />
  </div>
  ...
  <div class="flex items-center gap-3">
    ...
    {:else if isTauri}
      <div class="flex items-center gap-2 text-gray-500 dark:text-gray-400">
        ...
        <span class="text-sm">
          Hold <kbd class="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">Space</kbd>
          · Press <kbd class="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">Enter</kbd>
        </span>
      </div>
    {/if}
  </div>
